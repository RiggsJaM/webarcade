...
void main() {
  group('''TestingApiCalls''', () {
    ...
    testWidgets('''Parse already received response.''', (tester) async {
      ...
      await iCallTheParsejsonFunctionWith(tester, fetchedJson);
      await i(tester);
    });
  });
}
