...
void main() {
  ...
  group('fetchJsonResponse', () {
    test('returns a List of Definitions if the http call completes successfully', () async {
      ...
      final client = MockClient((_) async =>
        http.Response(responseList, 200, headers: {
          HttpHeaders.contentTypeHeader: 'application/json; charset=utf-8',
        }));
      expect(await api.getDefinitionRecord(client, "flutter"), isA<http.Response>());
