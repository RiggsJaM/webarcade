...
///Class that defines the build widget that is basis of the HangmanDebug page
class HangmanDebug extends StatelessWidget {
  const HangmanDebug({super.key});
  @override
...
///The page that HangmanDebug takes place on
class GamePageDebug extends StatefulWidget {
  @override
  State<GamePageDebug> createState() => GamePageDebugState();
}

///Class that holds the functionality and UI for the HangmanDebug game separated into widgets.
class GamePageDebugState extends State<GamePageDebug> {
  ...
  ///Widget that creates most of the functionality and visual elements of the HangmanDebug game
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: CommonDrawer(),
      body:
      //Column that holds the HangmanDebug keyboard, word, and images that are shown
      Column(
  ...
  Widget youLose() {
    ...
    return AlertDialog(
      ...
      actions: <Widget>[
        //Button that takes the user to a new game of HangmanDebug
        RawMaterialButton(
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => HangmanDebug(),));
          },
